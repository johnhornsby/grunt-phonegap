(function() {
  ...
  module.exports = icons = function(grunt) {
    ...
    return {
      build: function(fn) {
        var appName, phonegapPath, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, res;
        ...
        if (icons != null ? (ref10 = icons.ios) != null ? ref10.icon60x3 : void 0 : void 0) {
          grunt.file.copy(icons.ios.icon60x3, path.join(res, 'icon-60@3x.png'), {
            encoding: null
          });
        }
        if (icons != null ? (ref11 = icons.ios) != null ? ref11.icon72 : void 0 : void 0) {
          grunt.file.copy(icons.ios.icon72, path.join(res, 'icon-72.png'), {
            encoding: null
          });
        }
        if (icons != null ? (ref12 = icons.ios) != null ? ref12.icon72x2 : void 0 : void 0) {
          grunt.file.copy(icons.ios.icon72x2, path.join(res, 'icon-72@2x.png'), {
            encoding: null
          });
        }
        if (icons != null ? (ref13 = icons.ios) != null ? ref13.icon76 : void 0 : void 0) {
          grunt.file.copy(icons.ios.icon76, path.join(res, 'icon-76.png'), {
            encoding: null
          });
        }
        if (icons != null ? (ref14 = icons.ios) != null ? ref14.icon76x2 : void 0 : void 0) {
          grunt.file.copy(icons.ios.icon76x2, path.join(res, 'icon-76@2x.png'), {
            encoding: null
          });
        }
        if (icons != null ? (ref15 = icons.ios) != null ? ref15.icon512 : void 0 : void 0) {
          grunt.file.copy(icons.ios.icon512, path.join(res, 'icon-512.png'), {
            encoding: null
          });
        }
        if (icons != null ? (ref16 = icons.ios) != null ? ref16.icon512x2 : void 0 : void 0) {
