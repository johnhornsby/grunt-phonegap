(function() {
  ...
  module.exports = screens = function(grunt) {
    ...
    return {
      build: function(fn) {
        var appName, phonegapPath, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, res;
        ...
        if ((screens != null ? (ref7 = screens.ios) != null ? ref7.iphone667h : void 0 : void 0) != null) {
          grunt.file.copy(screens.ios.iphone667h, path.join(res, 'Default-667h.png'), {
            encoding: null
          });
        }
        if ((screens != null ? (ref8 = screens.ios) != null ? ref8.iphone736h : void 0 : void 0) != null) {
